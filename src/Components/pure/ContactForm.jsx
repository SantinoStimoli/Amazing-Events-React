...
const ContactForm = () => {
    return (
        <section className="text-gray-600 body-font relative">
            <div className="px-5 my-20 mx-auto flex flex-wrap-reverse justify-center">
                <div className="element-contact bg-gray-300 rounded-lg overflow-hidden flex items-end justify-start relative -z-10 w-full mt-10">
                    ...
                    <div className="bg-white bg-opacity-80 relative flex flex-wrap py-6 rounded shadow-md justify-center w-2/3 m-auto flex-col items-center info-section">
                ...
                <div className="element-contact form z-0 bg-white rounded-lg p-8 flex flex-col shadow-xl">
                    ...
                    <p className="chico text-xs text-gray-500 mt-3">Within 2 or 3 days you will receive our response in your email box</p>
                </div>
            </div>
        </section>
    );
