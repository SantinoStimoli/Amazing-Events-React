...
const EventHome = ({ eventsType }) => {
    return (
        <div className={`flex items-center flex-col justify-center my-5 max-lg:flex max-md:flex-col max-lg:my-10 max-md:my-5 ${eventsType === EVENT_TYPE.UPCOMING ? 'max-lg:flex-row-reverse' : 'max-lg:flex-row'}`}>
