    ...
    return (
        <div className='flex items-center flex-col justify-center my-5 '>
            ...
            <div>
                ...
                <Link to={eventsType === EVENT_TYPE.ALL ? '/events' : eventsType === EVENT_TYPE.UPCOMING ? '/events/upcoming' : '/events/past'} type="button" class="bg-personalizado focus:outline-none text-white  opacity-80 hover:opacity-100 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 ">View more...</Link>
            </div>
        </div>
    );
}
